...
def main(args):
    ...
    np.save(f'outputs/{args.video_name}/{args.video_name}_3D.npy', prediction2, allow_pickle=True)
    ...
    np.save(f'outputs/{args.video_name}/{args.video_name}_3D_postprocess.npy', prediction2, allow_pickle=True)
...
if __name__ == '__main__':
    ...
    for vid in video_files:
        ...
        inference_video('outputs/'+vid, 'alpha_pose')
